		...
		<div class="col-md-12">
			<div class="card">
					...
					<div class="card-body row">
						<div class="col-8">
							...
							<input type="text" class="form-control" id="disableinput"
								value="<?php echo $data_admin['username']; ?>" disabled>
							<br>
							<p>Password Lama</p>
				...
				if (isset($_POST['submit'])) {
					...
					if ($data_admin['password'] === $pass_lama) {
						if ($pass_baru === $re_pass_baru) {
							$result = $koneksi->query("UPDATE admin SET password = '$pass_baru' WHERE id = {$_SESSION['id_admin']}");
