			...
			<div class="card">
				<form method="POST" action="" enctype='multipart/form-data'>
					...
					<div class="card-body row">
						...
						<div class="col-md-6">
							...
							<input name="nama" type="text" class="form-control"
								value="<?php echo $data['nm_pegawai']; ?>">
							<br>

							<p>Tempat Tanggal Lahir</p>
							<input type="text" class="form-control" id="disableinput"
								value="<?php echo $data['ttl']; ?>" disabled>
							<br>
						...
						<div class="col-md-6">
							...
							<p>Alamat</p>
							<input name="alamat" type="text" class="form-control" id="disableinput"
					...
					<div class="px-3">
						...
						<div class="py-4">
							<input type="submit" name="submit" href="#" class="btn w-100 btn-success" value="Simpan" />
						</div>
					</div>
				</form>
				<?php
